...
(function( jQuery ){
  // var $module = jQuery('#m-1632153572875').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
    
jQuery(function () {
  var $hero = jQuery('#m-1632153260897');
  var $module = jQuery('#m-1632153260897').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1632153633396').children('.module');
