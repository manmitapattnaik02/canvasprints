          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597673791469');
  var $module = jQuery('#m-1597673791469').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
          ...
          jQuery(function () {
  var $hero = jQuery('#m-1597676863497');
  var $module = jQuery('#m-1597676863497').children('.module');
