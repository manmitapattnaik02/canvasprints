        ...
        jQuery(function() {
  var $hero = jQuery('#m-1593699480884');
  var $module = jQuery('#m-1593699480884').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
   ...
   changeImage();
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
        ...
        jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1593706865546').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1593706865546').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1593706865546');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1593706865546').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1593706865546').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1593706865546').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
    
        jQuery(function() {
            var $hero = jQuery('#m-1593714249268');
            var $module = jQuery('#m-1593714249268').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1593714249279');
            var $module = jQuery('#m-1593714249279').children('.module');
    ...
    jQuery(function() {
        var $module = jQuery('#m-1593714500083').children('.module');
        if(jQuery().gfYoutube) {
            $module.gfYoutube();
        }
    });
        ...
        jQuery(function() {
  try {
    var $module = jQuery('#m-1593714800383').children('.module');
    ...
    $module.children('[data-accordion]').children('[data-content]').children().css('border-bottom', borderSize + ' solid ' + borderColor);
        ...
        jQuery(function() {
  try {
    var $module = jQuery('#m-1593714500054').children('.module');   
    ...
    if ($module.parent().parent().closest('.module-wrap[data-label="Carousel"]').length > 0) {	
        ...
        jQuery(function() {
  var $hero = jQuery('#m-1593714500069');
  var $module = jQuery('#m-1593714500069').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
        ...
        jQuery(function() {
  var $hero = jQuery('#m-1593714500059');
  var $module = jQuery('#m-1593714500059').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
        ...
        jQuery(function() {
  var $hero = jQuery('#m-1593714500040');
  var $module = jQuery('#m-1593714500040').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
                            ...
                            jQuery(function(){
                                try{
                                    if(jQuery().gfV1Lazyload){
                                        var $module=jQuery(window);
                                        $module.gfV1Lazyload({delay:125})
                                    }
                                }catch(err){
                                    console.error(err)
                                }
