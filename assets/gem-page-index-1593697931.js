        ...
        jQuery(function() {
            var $hero = jQuery('#m-1592917894983');
            var $module = jQuery('#m-1592917894983').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1592917894848');
            var $module = jQuery('#m-1592917894848').children('.module');
        ...
        jQuery(function() {
  try {
    var $module = jQuery('#m-1592917894867').children('.module');   
    ...
    if ($module.parent().parent().closest('.module-wrap[data-label="Carousel"]').length > 0) {	
        ...
        jQuery(function() {
  var $hero = jQuery('#m-1592917894830');
  var $module = jQuery('#m-1592917894830').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
        ...
        jQuery(function() {
  var $hero = jQuery('#m-1592917894831');
  var $module = jQuery('#m-1592917894831').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
        ...
        jQuery(function() {
  var $hero = jQuery('#m-1592917894889');
  var $module = jQuery('#m-1592917894889').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    jQuery(function() {
        var $module = jQuery('#m-1592917894866').children('.module');
        if(jQuery().gfYoutube) {
            $module.gfYoutube();
        }
    });
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1592917894897');
            var $module = jQuery('#m-1592917894897').children('.module');
  ...
  if (mode == 'dev') {
      ...
      if (flag) {
        ...
        jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1593637043942').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1593637043942').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1593637043942');
      if ($bkLiquid && $bkLiquid.length > 0) {
          var $settings = $bkLiquid.find('.settings');
          try {
              var name = '';
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1593637043942').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1593637043942').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1593637043942').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
